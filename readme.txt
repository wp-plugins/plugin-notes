...
Version 1.1 introduced the ability to use HTML in notes.

Starting with *Plugin Notes 1.5* you can save a note as a template for new notes, use [markdown syntax](http://daringfireball.net/projects/markdown/syntax) and use a number of variables in the notes. Please have a look at the [FAQ](http://wordpress.org/plugins/plugin-notes/faq/) for more information about these features.

Also links in notes will now automagically have `target="_blank"` added so you won't accidently leave your site while working with the plugins.
...
3.  A bunch of notes added to plugins.
